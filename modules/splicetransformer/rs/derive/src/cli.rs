...
#[derive(Debug, Parser)]
#[command(name = "splicetransformer-derive", about = "derive SpliceTransformer scores", version = env!("CARGO_PKG_VERSION"))]
pub struct Args {
    #[arg(
        short = 'b',
        long = "bigwig-dir",
        required = true,
        value_name = "PATH",
        help = "Path to directory containing SpliceTransformer/SpliceAI BigWig files; filenames must include donor/acceptor and plus/minus tokens"
    )]
    pub bw_dir: PathBuf,
    ...
    #[arg(
        ...
        default_value_t = String::from("splicetransformer")
    )]
    pub prefix: String,
